        ...
        <div class="row">
            <div class="mx-auto col col-12 col-sm-11 col-md-9 col-lg-7 col-xl-6 mt-4" style="margin-bottom: 90px">
                ...
                <p class="text-center pt-4" style="font-size: 14px;">
                    ...
                    まだ登録していない方は<a class="text-decoration-none text-info"
                ...
                <div class="card mt-4 p-4 shadow-sm">
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" id="email" name="email" placeholder="メールアドレスを入力"
                        ...
                        <button type="submit"
                            class="btn btn-block bg-white btn-outline-info text-decoration-none text-info mt-4"><b>ログイン</b></button>
                    </form>
