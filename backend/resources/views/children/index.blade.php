...
@section('title', $child->name . '（お子さまのページ）-よんで-')
...
<div class="container">
    <div class="card mt-3">
        <div class="card-body">
            <h2 class="h4 card-title m-0">{{ $child->name }}</h2>
            <div class="card-text text-right">
                {{ $child->readRecords->count() }}件
            </div>
        </div>
    </div>
                    ...
                    <div class="card border-0">
                        <div class="card-body py-2">
                            <div class="card-title">
                                <span class="small">
                                    <i
                                        class="fas fa-book-reader"></i><b>よんだよ記録</b>({{ count($pictureBook->readRecords )}}回)
                                </span>
                            </div>
                            ...
                            <div class="pb-1">
                                ...
                                {{-- タグ --}}
                                @foreach($readRecord->tags as $child)
                                @if($loop->first)
                                {{-- <div class="card-body pt-0 pb-4 pl-3"> --}}
                                <div class="card-text line-height">
                                    @endif
                                    <a href="{{ route('tags.show', ['name' => $child->name]) }}"
