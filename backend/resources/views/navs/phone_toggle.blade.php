...
<div class="d-block d-md-none">
    ...
    <div class="d-flex align-items-center flex-wrap">
        {{-- home button (toggle) --}}
        <a href="{{ route('home') }}" class="btn btn-sm btn-outline-light shadow-sm small text-shadow mr-3 mb-2">
            <i class="fas fa-home mr-1"></i>ホーム
        </a>
        {{-- picture bookshelf button (toggle) --}}
        <a href="{{ route('families.bookshelf', ["name" => Auth::user()->family->name]) }}"
            class="btn btn-sm btn-outline-light shadow-sm small text-shadow mr-3 mb-2">
        ...
        <a href="{{ route("users.index", ["name" => Auth::user()->name]) }}"
            class="btn btn-sm btn-outline-light shadow-sm small text-shadow mr-3 mb-2">
            <i class="far fa-user-circle mr-1"></i>マイページ
        </a>
    ...
    <li class="nav-item mb-1">
        <a href="{{ route('register') }}" class="btn btn-sm btn-block bg-pink text-white font-weight-bold">新規登録</a>
    </li>
