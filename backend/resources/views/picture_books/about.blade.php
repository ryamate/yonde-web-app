        ...
        <div class="container" style="max-width: 900px;">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-light small pl-0 mb-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">よんでとは</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <div class="container" style="max-width: 900px">
        ...
        <div style="margin-top: 74px;">
                    ...
                    <div class="col-md-4">
                        <div class="card border-0 p-4">
                            ...
                            <div class="card-body p-0 text-secondary">
                                ...
                                <p class="card-text small">これからよみたい絵本、これまでよんだ絵本をいれることができます。<br>
                    ...
                    <div class="col-md-4">
                        <div class="card border-0 p-4">
                            ...
                            <div class="card-body p-0 text-secondary">
                                ...
                                <p class="card-text small">絵本の読み聞かせをした記録を付けることができます。<br>
                                    いつ読んだか、どの子に読んだか、何回目かなど、読んだ内容がより具体的にわかるようになります。</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="card border-0 p-4">
                            ...
                            <div class="card-body p-0 text-secondary">
                                ...
                                <p class="card-text small">絵本棚・読み聞かせ記録を家族と共有することができます。<br>
                                    絵本を読んだ記録が、家族のアルバムのように残ります。</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="text-center d-none d-md-block border-bottom pb-4 mx-5">
                <a href="" class="btn btn-outline-info mt-2 mb-2" role="button"
                    style="border-radius: 24px">　　　サンプル絵本棚をみてみる　　<i class="fas fa-chevron-right"></i></a>
            </div>
            {{-- smart phone --}}
            <div class="container">
                <div class="text-center d-block d-md-none border-bottom py-4">
                    <a href="" class="btn btn-block btn-outline-info mt-2 mb-2 rounded-pill"
                        role="button">　　サンプル絵本棚をみてみる　<i class="fas fa-chevron-right"></i></a>
                </div>
            </div>
